...
public class PhysicsObject : MonoBehaviour
{
    ...
    //[Header("Gravity")]
    [SerializeField] protected float terminalVelocityY = -10.0f;
    [SerializeField] protected const float defaultGravityY = -28.125f;
   ...
   // [Header("Collision")]
    [SerializeField] bool slopesReduceVelocity;
   ...
   // [Header("Grounding")]
    ...
    [SerializeField] protected float maxCeilingNormalY = -0.65f;
    ...
    protected void CheckVTrap(float pushStrength)
    {
        ...
        Vector2 pointA = c2D.bounds.min;
        Vector2 pointB = new Vector2(pointA.x + c2D.bounds.size.x, pointA.y);
